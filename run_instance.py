...
if __name__ == "__main__":
    ...
    parser.add_argument("--instance-type", help="Instance type (auto-detected from hardware if not provided)")
    ...
    if args.instance_type:
        print(f"Instance Type: {args.instance_type} (manual override)")
    else:
        print(f"Instance Type: Auto-detecting from hardware...")
